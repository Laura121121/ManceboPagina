    ...
    <main class="menu-content">
        <div class="container">
            ...
            <div class="menu-grid">
                <!-- Menu item 1 -->
                <div class="menu-item">
                    <img src="../IMG/p1.jpg" alt="Carpaccio de Res" class="menu-item-image">
                ...
                <!-- Menu item 2 -->
                <div class="menu-item">
                    <img src="../IMG/p2.jpg" alt="Bruschetta Clásica" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                ...
                <!-- Menu item 3 -->
                <div class="menu-item">
                    <img src="../IMG/p3.jpg" alt="Paella Valenciana" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                ...
                <div class="menu-item">
                    <img src="../IMG/p4.jpg" alt="Paella Valenciana" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                            <h3 class="menu-item-title">Paella Valenciana</h3>
                            <span class="menu-item-price">$25.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/p5.jpg" alt="Paella Valenciana" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                            <h3 class="menu-item-title">Paella Valenciana</h3>
                            <span class="menu-item-price">$25.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/p6.jpg" alt="Paella Valenciana" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                            <h3 class="menu-item-title">Paella Valenciana</h3>
                            <span class="menu-item-price">$25.95</span>
