...
<head>
    ...
    <link rel="stylesheet" href="../CSS/platprin.css">
    ...
    <main class="menu-content">
        <div class="container">
            ...
            <div class="menu-grid">
                <!-- Menu item 1 -->
                <div class="menu-item">
                    <img src="../IMG/d1.jpg" alt="Carpaccio de Res" class="menu-item-image">
                ...
                <!-- Menu item 2 -->
                <div class="menu-item">
                    <img src="../IMG/d2.jpg" alt="Bruschetta Clásica" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                ...
                <!-- Menu item 3 -->
                <div class="menu-item">
                    <img src="../IMG/d3.jpg" alt="Paella Valenciana" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
