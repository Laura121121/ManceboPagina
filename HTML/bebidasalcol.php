...
<head>
    ...
    <link rel="stylesheet" href="../CSS/bebaco.css">
...
<body>
    ...
    <main class="menu-content">
        <div class="container">
            ...
            <div class="menu-grid">
                <!-- Menu item 2 -->
                <div class="menu-item">
                    <img src="../IMG/ba1.jpg" alt="Bruschetta Clásica" class="menu-item-image">
                    ...
                    <!-- Menu item 2 -->
                    <div class="menu-item">
                      <img src="../IMG/ba2.jpg" alt="Bruschetta Clásica" class="menu-item-image">
                      <div class="menu-item-content">
                          <div class="menu-item-header">
                              <h3 class="menu-item-title">Bruschetta Clásica</h3>
                              <span class="menu-item-price">$8.95</span>
                ...
                <!-- Menu item 3 -->
                <div class="menu-item">
                    <img src="../IMG/ba3.jpg" alt="Paella Valenciana" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                ...
                <div class="menu-item">
                    <img src="../IMG/ba4.jpg" alt="Paella Valenciana" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                            <h3 class="menu-item-title">Paella Valenciana</h3>
                            <span class="menu-item-price">$25.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/ba5.jpg" alt="Paella Valenciana" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                            <h3 class="menu-item-title">Paella Valenciana</h3>
                            <span class="menu-item-price">$25.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/ba6.jpg" alt="Paella Valenciana" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                            <h3 class="menu-item-title">Paella Valenciana</h3>
                            <span class="menu-item-price">$25.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/ba7.jpg" alt="Paella Valenciana" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                            <h3 class="menu-item-title">Paella Valenciana</h3>
                            <span class="menu-item-price">$25.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/ba8.jpg" alt="Paella Valenciana" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                            <h3 class="menu-item-title">Paella Valenciana</h3>
                            <span class="menu-item-price">$25.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/ba9.jpg" alt="Paella Valenciana" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                            <h3 class="menu-item-title">Paella Valenciana</h3>
                            <span class="menu-item-price">$25.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/ba10.jpg" alt="Paella Valenciana" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                            <h3 class="menu-item-title">Paella Valenciana</h3>
                            <span class="menu-item-price">$25.95</span>
                    ...
                    <img src="../IMG/ba11.jpg" alt="Paella Valenciana" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                            <h3 class="menu-item-title">Paella Valenciana</h3>
                            <span class="menu-item-price">$25.95</span>
                    ...
                    <img src="../IMG/ba12.jpg" alt="Paella Valenciana" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                            <h3 class="menu-item-title">Paella Valenciana</h3>
                            <span class="menu-item-price">$25.95</span>
    ...
    <section class="section-footer">
        <footer class="footer">
          <div class="footer-group-container" id="#footer">
