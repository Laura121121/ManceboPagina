...
<head>
    ...
    <link rel="stylesheet" href="../CSS/asiaticos.css">
    ...
    <main class="menu-content">
        <div class="container">
            ...
            <div class="menu-grid">  
                <!-- Menu item 2 -->
                <div class="menu-item">
                    <img src="../IMG/a1.jpg" alt="Bruschetta Clásica" class="menu-item-image">
                ...
                <!-- Menu item 3 -->
                <div class="menu-item">
                    <img src="../IMG/a2.jpg" alt="Paella Valenciana" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                  ...
                  <!-- Menu item 1 -->
                <div class="menu-item">
                    <img src="../IMG/a3.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                 ...
                 <!-- Menu item 1 -->
                 <div class="menu-item">
                    <img src="../IMG/a4.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                 ...
                 <!-- Menu item 1 -->
                 <div class="menu-item">
                    <img src="../IMG/a5.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                 ...
                 <!-- Menu item 1 -->
                 <div class="menu-item">
                    <img src="../IMG/a6.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                 ...
                 <!-- Menu item 1 -->
                 <div class="menu-item">
                    <img src="../IMG/a7.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                 ...
                 <!-- Menu item 1 -->
                 <div class="menu-item">
                    <img src="../IMG/a8.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                 ...
                 <!-- Menu item 1 -->
                 <div class="menu-item">
                    <img src="../IMG/a9.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                 ...
                 <!-- Menu item 1 -->
                 <div class="menu-item">
                    <img src="../IMG/a10.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                 ...
                 <!-- Menu item 1 -->
                 <div class="menu-item">
                    <img src="../IMG/a11.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                 ...
                 <!-- Menu item 1 -->
                 <div class="menu-item">
                    <img src="../IMG/a12.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/a13.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/a14.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/a15.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/a16.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/a17.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/a18.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/a19.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/a120.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/a21.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
