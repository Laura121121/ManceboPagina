...
<head>
    ...
    <link rel="stylesheet" href="../CSS/envoltinis.css">
    ...
    <main class="menu-content">
        <div class="container">
            ...
            <div class="menu-grid">
                <!-- Menu item 1 -->
                <div class="menu-item">
                    <img src="../IMG/en1.jpg" alt="Carpaccio de Res" class="menu-item-image">
                ...
                <!-- Menu item 2 -->
                <div class="menu-item">
                    <img src="../IMG/en2.jpg" alt="Bruschetta Clásica" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                ...
                <!-- Menu item 3 -->
                <div class="menu-item">
                    <img src="../IMG/en3.jpg" alt="Paella Valenciana" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                ...
                <div class="menu-item">
                    <img src="../IMG/en4.jpg" alt="Paella Valenciana" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                            <h3 class="menu-item-title">Paella Valenciana</h3>
                            <span class="menu-item-price">$25.95</span>
