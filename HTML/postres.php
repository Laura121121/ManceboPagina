    ...
    <main class="menu-content">
        <div class="container">
            ...
            <div class="menu-grid">
                <!-- Menu item 1 -->
                <div class="menu-item">
                    <img src="../IMG/po1.jpg" alt="Carpaccio de Res" class="menu-item-image">
                ...
                <!-- Menu item 2 -->
                <div class="menu-item">
                    <img src="../IMG/po2.jpg" alt="Bruschetta Clásica" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                ...
                <!-- Menu item 3 -->
                <div class="menu-item">
                    <img src="../IMG/po3.jpg" alt="Paella Valenciana" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                ...
                <div class="menu-item">
                    <img src="../IMG/po4.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/po5.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/po6.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/po7.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/po8.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/po9.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/po10.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/po11.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/po12.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/po13.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/po14.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/po15.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
                ...
                <div class="menu-item">
                    <img src="../IMG/po16.jpg" alt="Carpaccio de Res" class="menu-item-image">
                    <div class="menu-item-content">
                        <div class="menu-item-header">
                         <h3 class="menu-item-title">Carpaccio de Res</h3>
                            <span class="menu-item-price">$12.95</span>
